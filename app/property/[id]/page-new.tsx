...
export default function PropertyDetailPage() {
  ...
  const handleContact = (type: 'phone' | 'email') => {
    ...
    if (type === 'phone') {
      ...
      window.open(`mailto:${property.contact.email}?subject=Inquiry about ${property.title}&body=Hi ${property.contact.name}, I'm interested in your property "${property.title}" listed for ₹${property.price.toLocaleString('en-IN')}. Please provide more details.`)
    }
  }
